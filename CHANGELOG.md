...
- Use constants from PSRs for log levels instead strings
- Removed minimun stability 'stable' from composer

### Fixed

- Some readme value types fixed
...
- The `PsrSimpleCacheAdapter` _has_ method returns `true` when the value is null, now use the _has_ method from implementation comparing `null !== null`
